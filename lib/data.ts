...
export const experiencesData = [
  {
    ...
    description: "Built APIs, applied JavaScript, used SQL, managed e-commerceinventory, and developed email functionality during an internship.",
  ...
  },
  {
    ...
    description: " Followed SDLC, developed APIs, ensured compatibility, participated in Agile, translateddesigns into code, optimized performance, and utilized CI/CD pipelines.",
    location: "Ahmedabad, Gujarat",
    company:"Canara Bank",
    icon: React.createElement(FaReact),
  ...
  {
    title: "Frontend Web Developer",
    description: "Developed and maintained web applications using modern technologies, improvedcode quality, and collaborated with teams for usability and integration.",
