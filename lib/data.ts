...
export const experiencesData = [
  {
    ...
    description: " Magneto IT Solutions<br>Built APIs, applied JavaScript, used SQL, managed e-commerce
  ...
  },
  {
    ...
    description: " Canara Bank<br>Followed SDLC, developed APIs, ensured compatibility, participated in Agile, translated
  ...
  {
    title: "Frontend Web Developer",
    description: " InsyghtAi<br>Developed and maintained web applications using modern technologies, improved 
